# Adreno™ Neural Fusion (ANF) SDK integration guide
...
The overlay is written into the SR output. Later post-processing can change its colors or hide parts of it. For mode descriptions, controls, validation steps, and artifact diagnosis, use the [ANF debug overlay guide](./DEBUG-OVERLAY.md).
...
- Include the QTI No-Login Binary License from [`LICENSE.txt`](./LICENSE.txt) with every redistribution of `libanf.so`.
...
- [Adreno™ Neural Fusion SDK repository](https://github.com/SnapdragonGameStudios/adreno-neural-fusion)
- [Adreno™ Neural Fusion debug overlay guide](./DEBUG-OVERLAY.md)
- [Adreno™ Neural Fusion Vulkan sample](https://github.com/SnapdragonGameStudios/adreno-gpu-vulkan-code-sample-framework/tree/main/samples/anf)
- [Adreno™ Neural Fusion plugin for Unreal Engine](https://github.com/SnapdragonGameStudios/snapdragon-game-plugins-for-unreal-engine#adreno-neural-fusion)
- [Adreno™ Neural Fusion plugin for Unity](https://github.com/SnapdragonGameStudios/com.qualcomm.snapdragon.adreno.neural.fusion)
